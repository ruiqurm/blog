+++
title = "Clangd Invalid AST问题"
date = 2024-10-22T11:22:00+08:00
draft = false
+++
...
## 生成kernel clangd文件的方法 {#生成kernel-clangd文件的方法}


### 可以用bear直接生成 {#可以用bear直接生成}


### 或者可以用gen_compile_commands.py {#或者可以用gen-compile-commands-dot-py}
...
加flag可以参考：[carbon-lang的pr](https://github.com/carbon-language/carbon-lang/pull/4164)
